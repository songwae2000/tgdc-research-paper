...
Every figure below is printed by \texttt{python run\_all.py}. Reproducing the paper is
...
seeded. \texttt{scripts/check\_paper.py} walks every table cell here and fails if a
